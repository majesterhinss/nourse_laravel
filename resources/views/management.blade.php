        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    ...
                    <div class="offcanvas-body">
                        <div>
                            Bienvenue sur votre espace administrateur. Priere de vous deconnecter avant de quitter votre espace administrateur.
                        </div>
                        <br>
                        <div class="dropdown mt-3">
                            <div class="md col-7">
                                ...
                                <a class="btn btn-warning row-3" href="/gestionTrajet">Gestion des trajets</a> <br><br><br>
